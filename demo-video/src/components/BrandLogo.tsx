...
// The login-screen brand lockup: the pelican mark above the gradient Cinzel
// "Foundry" wordmark. Presentational only — callers animate the entrance.
export const BrandLogo: React.FC<{ scale?: number }> = ({ scale = 1 }) => {
  return (
    <div
